...
public class DoublyLinkedList<E> {
	...
	// main method
	public DoublyLinkedList<String> conact(DoublyLinkedList<String> list1, DoublyLinkedList<String> list2) {
				
					 //list1.trailer = list2.header;  
					 //list2.header=list1.trailer;
				 //list2.header.prev=list1.trailer.next;
