 ...
 */
public class SinglyLinkedList_SelectByNodeIndex<E> implements Cloneable {
	// ---------------- nested Node class ----------------
	/**
	...
	public SinglyLinkedList_SelectByNodeIndex() {
	} // constructs an initially empty list
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		SinglyLinkedList_SelectByNodeIndex other = (SinglyLinkedList_SelectByNodeIndex) o; // use nonparameterized type
		if (size != other.size)
			return false;
	...
	@SuppressWarnings({ "unchecked" })
	public SinglyLinkedList_SelectByNodeIndex<E> clone() throws CloneNotSupportedException {
		// always use inherited Object.clone() to create the initial copy
		SinglyLinkedList_SelectByNodeIndex<E> other = (SinglyLinkedList_SelectByNodeIndex<E>) super.clone(); // safe
																												// cast
	...
	public static void main(String[] args) throws Exception {
		...
		SinglyLinkedList_SelectByNodeIndex<String> list = new SinglyLinkedList_SelectByNodeIndex<String>();
		list.addFirst("MSP");
		list.addLast("ATL");
		list.addLast("BOS");
		//
