 ...
 */
public class SinglyLinkedList_SelectByValue<E> implements Cloneable {
	// ---------------- nested Node class ----------------
	/**
	...
	public SinglyLinkedList_SelectByValue() {
	} // constructs an initially empty list
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		SinglyLinkedList_SelectByValue other = (SinglyLinkedList_SelectByValue) o; // use nonparameterized type
		if (size != other.size)
			return false;
	...
	@SuppressWarnings({ "unchecked" })
	public SinglyLinkedList_SelectByValue<E> clone() throws CloneNotSupportedException {
		// always use inherited Object.clone() to create the initial copy
		SinglyLinkedList_SelectByValue<E> other = (SinglyLinkedList_SelectByValue<E>) super.clone(); // safe cast
	...
	public void swapNodes(E key1, E key2) {
		...
		if (previousNodeOfKey1 == null) {
			head = currentNodeOfKey2;
		} else {
			previousNodeOfKey1.next = currentNodeOfKey2;
		}
		if (previousNodeOfKey2 == null) {
			head = currentNodeOfKey1;
		} else {
			previousNodeOfKey2.next = currentNodeOfKey1;
		}
		Node<E> temp = currentNodeOfKey2.next;
		currentNodeOfKey2.next = currentNodeOfKey1.next;
		currentNodeOfKey1.next = temp;
	}

	public static void main(String[] args) {

		SinglyLinkedList_SelectByValue<String> list = new SinglyLinkedList_SelectByValue<String>();
		list.addFirst("MSP");
		list.addLast("ATL");
		list.addLast("BOS");
		//
		...
		System.out.println("Now I want to change LAX and ATL and next point node");
